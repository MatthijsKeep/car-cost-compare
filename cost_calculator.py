...
def depreciate_value(purchase_price, is_used, month, decay_rate_new, decay_rate_used, residual_percentage):
    """Value and monthly depreciation using exponential decay: \( v(t) = p e^{-k t} \), steeper for new cars [web:20][web:24][web:28]."""
    k = decay_rate_used if is_used else decay_rate_new  # Annual decay rate
